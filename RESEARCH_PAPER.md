...
5. ~~Improve Track A's facility-level generalization~~ — **Substantially improved** (§5.1.1): exporting a matching second year of tiles for the under-represented facilities raised exhaustive LOFO mean recall from 47.2% to **69.1%**; data augmentation was tried on both dataset sizes and did not help either. *(Narrowly open: two specific facilities, Kudgi and ShriSingajiMalwa, still show 0% LOFO recall — worth a targeted follow-up rather than a general architecture/curriculum change.)*
